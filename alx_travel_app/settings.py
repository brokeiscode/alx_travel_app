...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': [
        ...
        'rest_framework.authentication.BasicAuthentication',   # Basic HTTP authentication
        # 'rest_framework.authentication.TokenAuthentication', # DRF's Token system
        # 'rest_framework_simplejwt.authentication.JWTAuthentication', # JWTs
    ],
